// $ANTLR 3.5.2 HL7QueryParser.g 2017-12-15 18:29:39
...
public class HL7QueryParser extends Parser {
	...
	@Override public String getGrammarFileName() { return "HL7QueryParser.g"; }
	...
	// HL7QueryParser.g:72:1: declareClause : DECLARE ^ declaration ( COMMA ! declaration )* ;
	public final HL7QueryParser.declareClause_return declareClause() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:72:15: ( DECLARE ^ declaration ( COMMA ! declaration )* )
			// HL7QueryParser.g:72:17: DECLARE ^ declaration ( COMMA ! declaration )*
			{
			...
			// HL7QueryParser.g:72:38: ( COMMA ! declaration )*
			loop1:
			while (true) {
				int alt1=2;
				...
				switch (alt1) {
				case 1 :
					// HL7QueryParser.g:72:39: COMMA ! declaration
					{
	...
	// HL7QueryParser.g:74:1: requiredOrOptional : ( REQUIRED | OPTIONAL );
	public final HL7QueryParser.requiredOrOptional_return requiredOrOptional() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:74:20: ( REQUIRED | OPTIONAL )
			// HL7QueryParser.g:
			{
			root_0 = (Object)adaptor.nil();
	...
	// HL7QueryParser.g:75:1: declaration : IDENTIFIER AS requiredOrOptional SEGMENT_NAME -> ^( DECLARATION IDENTIFIER requiredOrOptional SEGMENT_NAME ) ;
	public final HL7QueryParser.declaration_return declaration() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:75:13: ( IDENTIFIER AS requiredOrOptional SEGMENT_NAME -> ^( DECLARATION IDENTIFIER requiredOrOptional SEGMENT_NAME ) )
			// HL7QueryParser.g:75:15: IDENTIFIER AS requiredOrOptional SEGMENT_NAME
			{
			...
			// AST REWRITE
			// elements: SEGMENT_NAME, IDENTIFIER, requiredOrOptional
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
			...
			{
				// HL7QueryParser.g:76:2: ^( DECLARATION IDENTIFIER requiredOrOptional SEGMENT_NAME )
				{
	...
	// HL7QueryParser.g:79:1: selectClause : SELECT ^ selectableClause ;
	public final HL7QueryParser.selectClause_return selectClause() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:79:14: ( SELECT ^ selectableClause )
			// HL7QueryParser.g:79:16: SELECT ^ selectableClause
			{
			root_0 = (Object)adaptor.nil();
	...
	// HL7QueryParser.g:80:1: selectableClause : selectable ( COMMA ! selectable )* ;
	public final HL7QueryParser.selectableClause_return selectableClause() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:80:18: ( selectable ( COMMA ! selectable )* )
			// HL7QueryParser.g:80:20: selectable ( COMMA ! selectable )*
			{
			root_0 = (Object)adaptor.nil();
			...
			// HL7QueryParser.g:80:31: ( COMMA ! selectable )*
			loop2:
			while (true) {
				int alt2=2;
				...
				switch (alt2) {
				case 1 :
					// HL7QueryParser.g:80:32: COMMA ! selectable
					{
	...
	// HL7QueryParser.g:81:1: selectable : ( MESSAGE | ref | field ) ^ ( AS ! IDENTIFIER ^)? ;
	public final HL7QueryParser.selectable_return selectable() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:81:12: ( ( MESSAGE | ref | field ) ^ ( AS ! IDENTIFIER ^)? )
			// HL7QueryParser.g:81:14: ( MESSAGE | ref | field ) ^ ( AS ! IDENTIFIER ^)?
			{
			root_0 = (Object)adaptor.nil();


			// HL7QueryParser.g:81:14: ( MESSAGE | ref | field )
			int alt3=3;
			...
			switch (alt3) {
				case 1 :
					// HL7QueryParser.g:81:15: MESSAGE
					{
			...
			// HL7QueryParser.g:81:39: ( AS ! IDENTIFIER ^)?
			int alt4=2;
			...
			switch (alt4) {
				case 1 :
					// HL7QueryParser.g:81:40: AS ! IDENTIFIER ^
					{
	...
	// HL7QueryParser.g:84:1: whereClause : WHERE ^ conditions ;
	public final HL7QueryParser.whereClause_return whereClause() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:84:13: ( WHERE ^ conditions )
			// HL7QueryParser.g:84:15: WHERE ^ conditions
			{
			root_0 = (Object)adaptor.nil();
	...
	// HL7QueryParser.g:86:1: conditions : condition ( ( AND ^| OR ^) condition )* ;
	public final HL7QueryParser.conditions_return conditions() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:86:12: ( condition ( ( AND ^| OR ^) condition )* )
			// HL7QueryParser.g:86:14: condition ( ( AND ^| OR ^) condition )*
			{
			root_0 = (Object)adaptor.nil();
			...
			// HL7QueryParser.g:86:24: ( ( AND ^| OR ^) condition )*
			loop6:
			while (true) {
				int alt6=2;
				...
				switch (alt6) {
				case 1 :
					// HL7QueryParser.g:86:25: ( AND ^| OR ^) condition
					{
					// HL7QueryParser.g:86:25: ( AND ^| OR ^)
					int alt5=2;
	...
	// HL7QueryParser.g:88:1: condition : ( NOT ^ condition | LPAREN ! conditions RPAREN !| evaluation );
	public final HL7QueryParser.condition_return condition() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:88:11: ( NOT ^ condition | LPAREN ! conditions RPAREN !| evaluation )
			int alt7=3;
			switch ( input.LA(1) ) {
			case NOT:
				{
			...
			switch (alt7) {
				case 1 :
					// HL7QueryParser.g:88:13: NOT ^ condition
					{
					root_0 = (Object)adaptor.nil();
					...
					break;
				case 2 :
					// HL7QueryParser.g:88:30: LPAREN ! conditions RPAREN !
					{
					root_0 = (Object)adaptor.nil();
					...
					break;
				case 3 :
					// HL7QueryParser.g:88:59: evaluation
					{
					root_0 = (Object)adaptor.nil();
	...
	// HL7QueryParser.g:90:1: evaluation : expression ( unaryOperator ^| ( binaryOperator ^ expression ) ) ;
	public final HL7QueryParser.evaluation_return evaluation() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:90:12: ( expression ( unaryOperator ^| ( binaryOperator ^ expression ) ) )
			// HL7QueryParser.g:90:14: expression ( unaryOperator ^| ( binaryOperator ^ expression ) )
			{
			root_0 = (Object)adaptor.nil();
			...
			// HL7QueryParser.g:91:5: ( unaryOperator ^| ( binaryOperator ^ expression ) )
			int alt8=2;
			...
			switch (alt8) {
				case 1 :
					// HL7QueryParser.g:92:6: unaryOperator ^
					{
					...
					break;
				case 2 :
					// HL7QueryParser.g:93:8: ( binaryOperator ^ expression )
					{
					// HL7QueryParser.g:93:8: ( binaryOperator ^ expression )
					// HL7QueryParser.g:93:9: binaryOperator ^ expression
					{
	...
	// HL7QueryParser.g:96:1: expression : ( ( LPAREN ! expr RPAREN !) | expr );
	public final HL7QueryParser.expression_return expression() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:96:12: ( ( LPAREN ! expr RPAREN !) | expr )
			int alt9=2;
			...
			switch (alt9) {
				case 1 :
					// HL7QueryParser.g:96:14: ( LPAREN ! expr RPAREN !)
					{
					root_0 = (Object)adaptor.nil();


					// HL7QueryParser.g:96:14: ( LPAREN ! expr RPAREN !)
					// HL7QueryParser.g:96:15: LPAREN ! expr RPAREN !
					{
	...
	// $ANTLR start "expr"
	// HL7QueryParser.g:97:1: expr : ( ref | field | STRING_LITERAL | NUMBER );
	public final HL7QueryParser.expr_return expr() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:97:6: ( ref | field | STRING_LITERAL | NUMBER )
			int alt10=4;
			switch ( input.LA(1) ) {
			case IDENTIFIER:
			case SEGMENT_NAME:
			...
			switch (alt10) {
				...
				case 2 :
					...
					break;
				case 3 :
					// HL7QueryParser.g:97:22: STRING_LITERAL
					{
					root_0 = (Object)adaptor.nil();
	...
	// HL7QueryParser.g:99:1: unaryOperator : ( IS_NULL | NOT_NULL );
	public final HL7QueryParser.unaryOperator_return unaryOperator() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:99:15: ( IS_NULL | NOT_NULL )
			// HL7QueryParser.g:
			{
			root_0 = (Object)adaptor.nil();
	...
	// HL7QueryParser.g:100:1: binaryOperator : ( EQUALS | NOT_EQUALS | LT | GT | LE | GE );
	public final HL7QueryParser.binaryOperator_return binaryOperator() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:100:16: ( EQUALS | NOT_EQUALS | LT | GT | LE | GE )
			// HL7QueryParser.g:
			{
			root_0 = (Object)adaptor.nil();
	...
	// $ANTLR start "ref"
	// HL7QueryParser.g:102:1: ref : ( SEGMENT_NAME | IDENTIFIER ) ;
	public final HL7QueryParser.ref_return ref() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:102:5: ( ( SEGMENT_NAME | IDENTIFIER ) )
			// HL7QueryParser.g:
			{
			root_0 = (Object)adaptor.nil();
	...
	// $ANTLR start "field"
	// HL7QueryParser.g:103:1: field : ref DOT ^ NUMBER ( DOT ^ NUMBER ( DOT ^ NUMBER ( DOT ^ NUMBER )? )? )? ;
	public final HL7QueryParser.field_return field() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:103:7: ( ref DOT ^ NUMBER ( DOT ^ NUMBER ( DOT ^ NUMBER ( DOT ^ NUMBER )? )? )? )
			// HL7QueryParser.g:103:9: ref DOT ^ NUMBER ( DOT ^ NUMBER ( DOT ^ NUMBER ( DOT ^ NUMBER )? )? )?
			{
			root_0 = (Object)adaptor.nil();
			...
			// HL7QueryParser.g:104:2: ( DOT ^ NUMBER ( DOT ^ NUMBER ( DOT ^ NUMBER )? )? )?
			int alt13=2;
			...
			switch (alt13) {
				case 1 :
					// HL7QueryParser.g:104:3: DOT ^ NUMBER ( DOT ^ NUMBER ( DOT ^ NUMBER )? )?
					{
					...
					// HL7QueryParser.g:104:15: ( DOT ^ NUMBER ( DOT ^ NUMBER )? )?
					int alt12=2;
					...
					switch (alt12) {
						case 1 :
							// HL7QueryParser.g:104:16: DOT ^ NUMBER ( DOT ^ NUMBER )?
							{
							...
							// HL7QueryParser.g:104:28: ( DOT ^ NUMBER )?
							int alt11=2;
							...
							switch (alt11) {
								case 1 :
									// HL7QueryParser.g:104:29: DOT ^ NUMBER
									{
	...
	// $ANTLR start "query"
	// HL7QueryParser.g:107:1: query : ( declareClause )? selectClause ( whereClause )? EOF -> ^( QUERY ( declareClause )? selectClause ( whereClause )? ) ;
	public final HL7QueryParser.query_return query() throws RecognitionException {
		...
		try {
			// HL7QueryParser.g:107:7: ( ( declareClause )? selectClause ( whereClause )? EOF -> ^( QUERY ( declareClause )? selectClause ( whereClause )? ) )
			// HL7QueryParser.g:107:9: ( declareClause )? selectClause ( whereClause )? EOF
			{
			// HL7QueryParser.g:107:9: ( declareClause )?
			int alt14=2;
			...
			// HL7QueryParser.g:107:37: ( whereClause )?
			int alt15=2;
			...
			// AST REWRITE
			// elements: declareClause, whereClause, selectClause
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
			...
			{
				// HL7QueryParser.g:108:2: ^( QUERY ( declareClause )? selectClause ( whereClause )? )
				{
				Object root_1 = (Object)adaptor.nil();
				root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(QUERY, "QUERY"), root_1);
				// HL7QueryParser.g:108:10: ( declareClause )?
				...
				// HL7QueryParser.g:108:38: ( whereClause )?
