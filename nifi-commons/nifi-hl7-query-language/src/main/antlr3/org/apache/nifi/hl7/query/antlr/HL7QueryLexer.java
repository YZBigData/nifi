// $ANTLR 3.5.2 HL7QueryLexer.g 2017-12-15 18:29:22
...
public class HL7QueryLexer extends Lexer {
	...
	@Override public String getGrammarFileName() { return "HL7QueryLexer.g"; }
	...
	public final void mWHITESPACE() throws RecognitionException {
		try {
			...
			// HL7QueryLexer.g:69:12: ( ( ' ' | '\\t' | '\\n' | '\\r' )+ )
			// HL7QueryLexer.g:69:14: ( ' ' | '\\t' | '\\n' | '\\r' )+
			{
			// HL7QueryLexer.g:69:14: ( ' ' | '\\t' | '\\n' | '\\r' )+
			int cnt1=0;
			loop1:
	...
	public final void mCOMMENT() throws RecognitionException {
		try {
			int _type = COMMENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:70:9: ( '#' (~ ( '\\n' ) )* '\\n' )
			// HL7QueryLexer.g:70:11: '#' (~ ( '\\n' ) )* '\\n'
			{
			match('#'); 
			// HL7QueryLexer.g:70:15: (~ ( '\\n' ) )*
			loop2:
			while (true) {
				int alt2=2;
	...
	public final void mLPAREN() throws RecognitionException {
		try {
			int _type = LPAREN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:72:8: ( '(' )
			// HL7QueryLexer.g:72:10: '('
			{
			match('('); 
			}
	...
	public final void mRPAREN() throws RecognitionException {
		try {
			int _type = RPAREN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:73:8: ( ')' )
			// HL7QueryLexer.g:73:10: ')'
			{
			match(')'); 
			}
	...
	public final void mLBRACE() throws RecognitionException {
		try {
			int _type = LBRACE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:74:9: ( '{' )
			// HL7QueryLexer.g:74:11: '{'
			{
			match('{'); 
			}
	...
	public final void mRBRACE() throws RecognitionException {
		try {
			int _type = RBRACE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:75:9: ( '}' )
			// HL7QueryLexer.g:75:11: '}'
			{
			match('}'); 
			}
	...
	public final void mCOLON() throws RecognitionException {
		try {
			int _type = COLON;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:76:7: ( ':' )
			// HL7QueryLexer.g:76:9: ':'
			{
			match(':'); 
			}
	...
	public final void mCOMMA() throws RecognitionException {
		try {
			int _type = COMMA;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:77:7: ( ',' )
			// HL7QueryLexer.g:77:9: ','
			{
			match(','); 
			}
	...
	public final void mDOT() throws RecognitionException {
		try {
			int _type = DOT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:78:6: ( '.' )
			// HL7QueryLexer.g:78:8: '.'
			{
			match('.'); 
			}
	...
	public final void mSEMICOLON() throws RecognitionException {
		try {
			int _type = SEMICOLON;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:79:11: ( ';' )
			// HL7QueryLexer.g:79:13: ';'
			{
			match(';'); 
			}
	...
	public final void mEQUALS() throws RecognitionException {
		try {
			int _type = EQUALS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:84:9: ( '=' )
			// HL7QueryLexer.g:84:11: '='
			{
			match('='); 
			}
	...
	public final void mNOT_EQUALS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:85:12: ( '!=' )
			// HL7QueryLexer.g:85:14: '!='
			{
			match("!="); 
	...
	public final void mGT() throws RecognitionException {
		try {
			int _type = GT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:86:6: ( '>' )
			// HL7QueryLexer.g:86:8: '>'
			{
			match('>'); 
			}
	...
	public final void mGE() throws RecognitionException {
		try {
			int _type = GE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:87:6: ( '>=' )
			// HL7QueryLexer.g:87:8: '>='
			{
			match(">="); 
	...
	public final void mLT() throws RecognitionException {
		try {
			int _type = LT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:88:6: ( '<' )
			// HL7QueryLexer.g:88:8: '<'
			{
			match('<'); 
			}
	...
	public final void mLE() throws RecognitionException {
		try {
			int _type = LE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:89:6: ( '<=' )
			// HL7QueryLexer.g:89:8: '<='
			{
			match("<="); 
	...
	public final void mREGEX() throws RecognitionException {
		try {
			int _type = REGEX;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:90:8: ( 'MATCHES REGEX' )
			// HL7QueryLexer.g:90:10: 'MATCHES REGEX'
			{
			match("MATCHES REGEX"); 
	...
	public final void mLIKE() throws RecognitionException {
		try {
			int _type = LIKE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:91:7: ( 'LIKE' )
			// HL7QueryLexer.g:91:9: 'LIKE'
			{
			match("LIKE"); 
	...
	public final void mIS_NULL() throws RecognitionException {
		try {
			int _type = IS_NULL;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:92:10: ( 'IS NULL' )
			// HL7QueryLexer.g:92:12: 'IS NULL'
			{
			match("IS NULL"); 
	...
	public final void mNOT_NULL() throws RecognitionException {
		try {
			int _type = NOT_NULL;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:93:10: ( 'NOT NULL' )
			// HL7QueryLexer.g:93:12: 'NOT NULL'
			{
			match("NOT NULL"); 
	...
	public final void mAND() throws RecognitionException {
		try {
			int _type = AND;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:97:7: ( 'AND' )
			// HL7QueryLexer.g:97:9: 'AND'
			{
			match("AND"); 
	...
	public final void mOR() throws RecognitionException {
		try {
			int _type = OR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:98:6: ( 'OR' )
			// HL7QueryLexer.g:98:8: 'OR'
			{
			match("OR"); 
	...
	public final void mNOT() throws RecognitionException {
		try {
			int _type = NOT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:99:7: ( 'NOT' )
			// HL7QueryLexer.g:99:9: 'NOT'
			{
			match("NOT"); 
	...
	public final void mTRUE() throws RecognitionException {
		try {
			int _type = TRUE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:101:6: ( 'true' )
			// HL7QueryLexer.g:101:8: 'true'
			{
			match("true"); 
	...
	public final void mFALSE() throws RecognitionException {
		try {
			int _type = FALSE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:102:7: ( 'false' )
			// HL7QueryLexer.g:102:9: 'false'
			{
			match("false"); 
	...
	public final void mSELECT() throws RecognitionException {
		try {
			int _type = SELECT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:104:9: ( 'select' | 'SELECT' )
			int alt3=2;
	...
	public final void mDECLARE() throws RecognitionException {
		try {
			int _type = DECLARE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:105:10: ( 'declare' | 'DECLARE' )
			int alt4=2;
			...
			switch (alt4) {
				case 1 :
					// HL7QueryLexer.g:105:12: 'declare'
					{
					match("declare"); 
					...
					break;
				case 2 :
					// HL7QueryLexer.g:105:24: 'DECLARE'
					{
					match("DECLARE"); 
	...
	public final void mOPTIONAL() throws RecognitionException {
		try {
			int _type = OPTIONAL;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:106:10: ( 'optional' | 'OPTIONAL' )
			int alt5=2;
			...
			switch (alt5) {
				case 1 :
					// HL7QueryLexer.g:106:12: 'optional'
					{
					match("optional"); 
					...
					break;
				case 2 :
					// HL7QueryLexer.g:106:25: 'OPTIONAL'
					{
					match("OPTIONAL"); 
	...
	public final void mREQUIRED() throws RecognitionException {
		try {
			int _type = REQUIRED;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:107:10: ( 'required' | 'REQUIRED' )
			int alt6=2;
			...
			switch (alt6) {
				case 1 :
					// HL7QueryLexer.g:107:12: 'required'
					{
					match("required"); 
					...
					break;
				case 2 :
					// HL7QueryLexer.g:107:25: 'REQUIRED'
					{
					match("REQUIRED"); 
	...
	public final void mWHERE() throws RecognitionException {
		try {
			int _type = WHERE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:109:8: ( 'where' | 'WHERE' )
			int alt8=2;
	...
	public final void mMESSAGE() throws RecognitionException {
		try {
			int _type = MESSAGE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:111:10: ( 'MESSAGE' | 'message' )
			int alt9=2;
			...
			switch (alt9) {
				case 1 :
					// HL7QueryLexer.g:111:12: 'MESSAGE'
					{
					match("MESSAGE"); 
					...
					break;
				case 2 :
					// HL7QueryLexer.g:111:24: 'message'
					{
					match("message"); 
	...
	public final void mSEGMENT() throws RecognitionException {
		try {
			int _type = SEGMENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:112:10: ( 'SEGMENT' | 'segment' )
			int alt10=2;
			...
			switch (alt10) {
				case 1 :
					// HL7QueryLexer.g:112:12: 'SEGMENT'
					{
					match("SEGMENT"); 
					...
					break;
				case 2 :
					// HL7QueryLexer.g:112:24: 'segment'
					{
					match("segment"); 
	...
	public final void mSEGMENT_NAME() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:115:14: ( LETTER ALPHA_NUMERIC ALPHA_NUMERIC )
			// HL7QueryLexer.g:115:16: LETTER ALPHA_NUMERIC ALPHA_NUMERIC
			{
			mLETTER(); 
	...
	public final void mNUMBER() throws RecognitionException {
		try {
			int _type = NUMBER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:118:8: ( ( '0' .. '9' )+ )
			// HL7QueryLexer.g:118:10: ( '0' .. '9' )+
			{
			// HL7QueryLexer.g:118:10: ( '0' .. '9' )+
			int cnt11=0;
			loop11:
	...
	public final void mALPHA_NUMERIC() throws RecognitionException {
		try {
			// HL7QueryLexer.g:120:24: ( 'A' .. 'Z' | '0' .. '9' )
			// HL7QueryLexer.g:
			{
	...
	public final void mSTRING_LITERAL() throws RecognitionException {
		try {
			...
			// HL7QueryLexer.g:126:2: ( ( '\"' (escaped= ESC |normal=~ ( '\"' | '\\\\' | '\\n' | '\\r' | '\\t' ) )* '\"' ) | ( '\\'' (escaped= ESC |normal=~ ( '\\'' | '\\\\' | '\\n' | '\\r' | '\\t' ) )* '\\'' ) )
			int alt14=2;
			...
			switch (alt14) {
				case 1 :
					// HL7QueryLexer.g:127:3: ( '\"' (escaped= ESC |normal=~ ( '\"' | '\\\\' | '\\n' | '\\r' | '\\t' ) )* '\"' )
					{
					// HL7QueryLexer.g:127:3: ( '\"' (escaped= ESC |normal=~ ( '\"' | '\\\\' | '\\n' | '\\r' | '\\t' ) )* '\"' )
					// HL7QueryLexer.g:128:4: '\"' (escaped= ESC |normal=~ ( '\"' | '\\\\' | '\\n' | '\\r' | '\\t' ) )* '\"'
					{
					match('\"'); 
					// HL7QueryLexer.g:129:5: (escaped= ESC |normal=~ ( '\"' | '\\\\' | '\\n' | '\\r' | '\\t' ) )*
					loop12:
					while (true) {
						int alt12=3;
						...
						switch (alt12) {
						case 1 :
							// HL7QueryLexer.g:130:6: escaped= ESC
							{
					...
					break;
				case 2 :
					// HL7QueryLexer.g:139:3: ( '\\'' (escaped= ESC |normal=~ ( '\\'' | '\\\\' | '\\n' | '\\r' | '\\t' ) )* '\\'' )
					{
					// HL7QueryLexer.g:139:3: ( '\\'' (escaped= ESC |normal=~ ( '\\'' | '\\\\' | '\\n' | '\\r' | '\\t' ) )* '\\'' )
					// HL7QueryLexer.g:140:4: '\\'' (escaped= ESC |normal=~ ( '\\'' | '\\\\' | '\\n' | '\\r' | '\\t' ) )* '\\''
					{
					match('\''); 
					// HL7QueryLexer.g:141:5: (escaped= ESC |normal=~ ( '\\'' | '\\\\' | '\\n' | '\\r' | '\\t' ) )*
					loop13:
					while (true) {
						int alt13=3;
						...
						switch (alt13) {
						case 1 :
							// HL7QueryLexer.g:142:6: escaped= ESC
							{
	...
	public final void mESC() throws RecognitionException {
		try {
			...
			// HL7QueryLexer.g:155:2: ( '\\\\' ( '\"' | '\\'' | 'r' | 'n' | 't' | '\\\\' |nextChar=~ ( '\"' | '\\'' | 'r' | 'n' | 't' | '\\\\' ) ) )
			// HL7QueryLexer.g:155:4: '\\\\' ( '\"' | '\\'' | 'r' | 'n' | 't' | '\\\\' |nextChar=~ ( '\"' | '\\'' | 'r' | 'n' | 't' | '\\\\' ) )
			{
			match('\\'); 
			// HL7QueryLexer.g:156:3: ( '\"' | '\\'' | 'r' | 'n' | 't' | '\\\\' |nextChar=~ ( '\"' | '\\'' | 'r' | 'n' | 't' | '\\\\' ) )
			int alt15=7;
			...
			switch (alt15) {
				...
				case 6 :
					...
					break;
				case 7 :
					// HL7QueryLexer.g:163:6: nextChar=~ ( '\"' | '\\'' | 'r' | 'n' | 't' | '\\\\' )
					{
					nextChar= input.LA(1);
	...
	public final void mIDENTIFIER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HL7QueryLexer.g:170:12: ( (~ ( '$' | '{' | '}' | '(' | ')' | '[' | ']' | ',' | ':' | ';' | '/' | '*' | '\\'' | ' ' | '\\t' | '\\r' | '\\n' | '0' .. '9' | '.' ) (~ ( '$' | '{' | '}' | '(' | ')' | '[' | ']' | ',' | ':' | ';' | '/' | '*' | '\\'' | ' ' | '\\t' | '\\r' | '\\n' | '.' ) )* ) )
			// HL7QueryLexer.g:170:14: (~ ( '$' | '{' | '}' | '(' | ')' | '[' | ']' | ',' | ':' | ';' | '/' | '*' | '\\'' | ' ' | '\\t' | '\\r' | '\\n' | '0' .. '9' | '.' ) (~ ( '$' | '{' | '}' | '(' | ')' | '[' | ']' | ',' | ':' | ';' | '/' | '*' | '\\'' | ' ' | '\\t' | '\\r' | '\\n' | '.' ) )* )
			{
			// HL7QueryLexer.g:170:14: (~ ( '$' | '{' | '}' | '(' | ')' | '[' | ']' | ',' | ':' | ';' | '/' | '*' | '\\'' | ' ' | '\\t' | '\\r' | '\\n' | '0' .. '9' | '.' ) (~ ( '$' | '{' | '}' | '(' | ')' | '[' | ']' | ',' | ':' | ';' | '/' | '*' | '\\'' | ' ' | '\\t' | '\\r' | '\\n' | '.' ) )* )
			// HL7QueryLexer.g:171:7: ~ ( '$' | '{' | '}' | '(' | ')' | '[' | ']' | ',' | ':' | ';' | '/' | '*' | '\\'' | ' ' | '\\t' | '\\r' | '\\n' | '0' .. '9' | '.' ) (~ ( '$' | '{' | '}' | '(' | ')' | '[' | ']' | ',' | ':' | ';' | '/' | '*' | '\\'' | ' ' | '\\t' | '\\r' | '\\n' | '.' ) )*
			{
	...
	public void mTokens() throws RecognitionException {
		// HL7QueryLexer.g:1:8: ( WHITESPACE | COMMENT | LPAREN | RPAREN | LBRACE | RBRACE | COLON | COMMA | DOT | SEMICOLON | EQUALS | NOT_EQUALS | GT | GE | LT | LE | REGEX | LIKE | IS_NULL | NOT_NULL | AND | OR | NOT | TRUE | FALSE | SELECT | DECLARE | OPTIONAL | REQUIRED | AS | WHERE | MESSAGE | SEGMENT | SEGMENT_NAME | NUMBER | STRING_LITERAL | IDENTIFIER )
		int alt17=37;
		alt17 = dfa17.predict(input);
		switch (alt17) {
			case 1 :
				// HL7QueryLexer.g:1:10: WHITESPACE
				{
				mWHITESPACE(); 
			...
			case 9 :
				...
				break;
			case 10 :
				// HL7QueryLexer.g:1:73: SEMICOLON
				{
				mSEMICOLON(); 
			...
			case 11 :
				...
				break;
			case 12 :
				// HL7QueryLexer.g:1:90: NOT_EQUALS
				{
				mNOT_EQUALS(); 
			...
			case 19 :
				...
				break;
			case 20 :
				// HL7QueryLexer.g:1:132: NOT_NULL
				{
				mNOT_NULL(); 
			...
			case 27 :
				...
				break;
			case 28 :
				// HL7QueryLexer.g:1:178: OPTIONAL
				{
				mOPTIONAL(); 
				...
				break;
			case 29 :
				// HL7QueryLexer.g:1:187: REQUIRED
				{
				mREQUIRED(); 
			...
			case 33 :
				...
				break;
			case 34 :
				// HL7QueryLexer.g:1:221: SEGMENT_NAME
				{
				mSEGMENT_NAME(); 
			...
			case 35 :
				...
				break;
			case 36 :
				// HL7QueryLexer.g:1:241: STRING_LITERAL
				{
				mSTRING_LITERAL(); 
				...
				break;
			case 37 :
				// HL7QueryLexer.g:1:256: IDENTIFIER
				{
				mIDENTIFIER(); 
